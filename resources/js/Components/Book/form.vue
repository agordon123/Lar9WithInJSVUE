                        ...
                        <div class="">
                            ...
                            <div class="mb-4">
                                <label for="formBookImage"
                                       ...
                                       <file-pond name="imageFilePond" ref="pond" v-bind:allow-multiple="false" accepted-file-types="image/png,image/jpeg"
                                       v-bind:server="{
                                        url:'',
                                        timeout:7000,
                                        process:{
                                            ...
                                            onerror:()=>{},
                                            headers:{
                                                'X-CRSF-TOKEN':$page.props.csrf_token
                                            },
...
<script>
    ...
    const filepond = vueFilePond(
        FilePondPluginFileValidateType,FilePondPluginImagePreview,FilePondPluginFilePoster
    )
    export default {
    ...
    methods:{
        ...
        handleFilePondRevert(uniqueID,load,error){
            axios.post('/upload-books-revert',{image:this.form.image});
            load();
        }
